...
You can [download this App](https://software-store.zeiss.com/products/apps/file-selection-and-filtering) from the [ZEISS Quality Software Store](https://software-store.zeiss.com).
