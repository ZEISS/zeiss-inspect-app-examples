...
import gom.api.extensions                                    # pragma: no cover
import gom.api.extensions.actuals                            # pragma: no cover
...
class ActualCircle(gom.api.extensions.actuals.Circle):
    ...
    def __init__(self):
        ...
        super().__init__(id='pytest_template.custom_actual_circle', description='Custom Actual Circle')

    def dialog(self, context, args):
        """Show the creation dialog and return the user-provided parameters."""
        return self.show_dialog(context, args, '/custom_elements/Custom_Circle.gdlg')
...
class NominalCircle(gom.api.extensions.nominals.Circle):
    ...
    def __init__(self):
        ...
        super().__init__(
            id='pytest_template.custom_nominal_circle',
