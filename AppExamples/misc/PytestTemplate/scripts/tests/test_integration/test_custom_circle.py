...
SERVICE_ENDPOINT = 'gom.api.pytest_template.custom_circle'
...
def test_actual_circle():
    ...
    gom.script.customelements.create_actual(
        contribution='pytest_template.custom_actual_circle',
        name=name,
        values={
...
def test_nominal_circle():
    ...
    gom.script.customelements.create_nominal(
        contribution='pytest_template.custom_nominal_circle',
        name=name,
        values={
            'center_x': CENTER_X, 'center_y': CENTER_Y, 'center_z': CENTER_Z,
            'dir_x': DIR_X, 'dir_y': DIR_Y, 'dir_z': DIR_Z,
