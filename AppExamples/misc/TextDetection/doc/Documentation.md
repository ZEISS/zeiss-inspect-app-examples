...
A detailed documentation can be found in the ZEISS Quality Tech Guide: [How to Create an Advanced App](https://techguide.zeiss.com/en/zeiss-inspect-2026/article/how_to_create_an_advanced_add_on.html).
