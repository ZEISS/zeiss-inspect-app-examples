...
| <a id="IPCWebsocketBasics">IPCWebsocketBasics</a><br>[view](misc/IPCWebsocketBasics/doc/Documentation.md)  | Basic example for triggering command execution in ZEISS INSPECT from command line via WebSocket protocol | |  |  |
