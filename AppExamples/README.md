...
| <a id="OSMMapCustomDiagram">OSMMapCustomDiagram</a><br>[view](custom_diagrams/OSMMapCustomDiagram/doc/Documentation.md)  | Display geolocation data in an OpenStreetMap custom diagram. | | [HowTo - Custom Diagrams](https://zeiss.github.io/zeiss-inspect-app-api/2027/howtos/using_custom_diagrams/using_custom_diagrams.html)<br>[API - diagrams](https://zeiss.github.io/zeiss-inspect-app-api/2027/python_api/python_api.html#gom-api-extensions-diagrams-customdiagram)<br> | ZEISS INSPECT 2027 | [![Static Badge](https://img.shields.io/badge/custom--diagrams-blue)](#custom-diagrams)<br>[![Static Badge](https://img.shields.io/badge/custom--elements-blue)](#custom-elements)<br>[![Static Badge](https://img.shields.io/badge/cartopy-blue)](#cartopy)<br>[![Static Badge](https://img.shields.io/badge/openstreetmap-blue)](#openstreetmap)<br> |
...
| <a id="CustomSurfaceDeformMesh">CustomSurfaceDeformMesh</a><br>[view](custom_elements/CustomSurfaceDeformMesh/doc/Documentation.md)  | This example creates a custom actual surface by applying trimesh noise deformation to a selected mesh or CAD body. | [1)](#example-projects)  | [HowTo](https://zeiss.github.io/zeiss-inspect-app-api/2027/howtos/custom_elements/custom_nominals_actuals.html)<br>[API - actuals.Surface](https://zeiss.github.io/zeiss-inspect-app-api/2027/python_api/python_api.html#gom-api-extensions-actuals-surface)<br> | ZEISS INSPECT 2027 | [![Static Badge](https://img.shields.io/badge/mesh-blue)](#mesh)<br>[![Static Badge](https://img.shields.io/badge/surface-blue)](#surface)<br>[![Static Badge](https://img.shields.io/badge/custom--element-blue)](#custom-element)<br>[![Static Badge](https://img.shields.io/badge/trimesh-blue)](#trimesh)<br> |
...
| <a id="DisplayImage">DisplayImage</a><br>[view](misc/DisplayImage/doc/Documentation.md)  | Display measurement as a single image | |  | ZEISS INSPECT 2027 | [![Static Badge](https://img.shields.io/badge/image--widget-blue)](#image-widget)<br>[![Static Badge](https://img.shields.io/badge/measurement-blue)](#measurement)<br> |
| <a id="ExcelExample">ExcelExample</a><br>[view](misc/ExcelExample/doc/Documentation.md)  | Example for reading and writing Excel files from an App | |  | ZEISS INSPECT 2027 | [![Static Badge](https://img.shields.io/badge/import-blue)](#import)<br>[![Static Badge](https://img.shields.io/badge/export-blue)](#export)<br>[![Static Badge](https://img.shields.io/badge/project--keywords-blue)](#project-keywords)<br> |
...
| <a id="IPCWebsocketBasics">IPCWebsocketBasics</a><br>[view](misc/IPCWebsocketBasics/doc/Documentation.md)  | Basic example for triggering command execution in ZEISS INSPECT from command line via WebSocket protocol | |  | ZEISS INSPECT 2027 |  |
...
| <a id="TextDetection">TextDetection</a><br>[view](misc/TextDetection/doc/Documentation.md)  | Text detection example | |  | ZEISS INSPECT 2027 | [![Static Badge](https://img.shields.io/badge/measurement-blue)](#measurement)<br>[![Static Badge](https://img.shields.io/badge/image--widget-blue)](#image-widget)<br> |
...
* [OSMMapCustomDiagram](#OSMMapCustomDiagram)
...
* [CustomSurfaceDeformMesh](#CustomSurfaceDeformMesh)
