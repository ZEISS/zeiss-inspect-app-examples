...
You can [download this App](https://software-store.zeiss.com/products/apps/scripted-actual-distance) from the [ZEISS Quality Software Store](https://software-store.zeiss.com).
