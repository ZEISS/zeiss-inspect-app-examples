...
You can [download this App](https://software-store.zeiss.com/products/apps/scripted-actual-section) from the [ZEISS Quality Software Store](https://software-store.zeiss.com).
