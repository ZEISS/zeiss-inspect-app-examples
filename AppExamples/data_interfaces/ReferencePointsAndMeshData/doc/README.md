...
You can [download this App](https://software-store.zeiss.com/products/apps/reference-points-and-mesh-data) from the [ZEISS Quality Software Store](https://software-store.zeiss.com).
